                            ...
                            <table className="table table-hover mb-0">
                                <thead className="table-dark">
                                    <tr>
                                        ...
                                        <th scope="col">
                                            <i className="bx bx-money me-1"></i>Amount
                                        </th>
                                        <th scope="col">
                                            <i className="bx bx-calendar me-1"></i>Date
                                        </th>
                                        <th scope="col">
                                            <i className="bx bx-credit-card me-1"></i>Payment Method
                                        </th>
                                        <th scope="col">
                            ...
                            {selectedTransaction ? (
                                <div className="row g-3">
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        <p className="mb-0 text-capitalize">Expense</p>
                                    </div>
                                    <div className="col-md-6">
                                        <label className="form-label fw-semibold">Category</label>
                                        <p className="mb-0 text-capitalize">{selectedTransaction.category}</p>
                                    </div>
                                    <div className="col-md-6">
                                        <label className="form-label fw-semibold">Amount</label>
                                        <p className="mb-0">{formatCurrency(selectedTransaction.amount)}</p>
                                    </div>
                                    <div className="col-md-6">
                                        <label className="form-label fw-semibold">Date</label>
                                        <p className="mb-0">{formatDate(selectedTransaction.date)}</p>
                                    </div>
                                    <div className="col-md-6">
                                        <label className="form-label fw-semibold">Payment Method</label>
                                        <p className="mb-0 text-capitalize">{selectedTransaction.paymentMethod || "Unknown"}</p>
                                    </div>
                                    <div className="col-12">
                                    ...
                                    <div className="col-12">
                                        ...
                                        <p className="mb-0">{selectedTransaction.notes || "No notes"}</p>
                                    </div>
                                    <div className="col-12">
                                        <label className="form-label fw-semibold">Tags</label>
                                        <p className="mb-0">{selectedTransaction.tags.length > 0 ? selectedTransaction.tags.join(", ") : "No tags"}</p>
                                    </div>
                                    <div className="col-12">
                                        <label className="form-label fw-semibold">Status</label>
                                        <p className="mb-0 text-capitalize">Completed</p>
                                    </div>
                                </div>
                            ) : (
